...
const content = {
    KR: {
        ...
        workDesc: '기존 유클리드 공식은 두 변수의 상호작용과 제약 조건($\gcd(m,k)=1$)으로 인해 AI가 구조적 규칙을 찾기 어렵습니다. 본 연구는 슈티펠의 고전적 수열을 단일 변수 $n$으로 변환한 **Index Theory**를 사용하여, AI에게 가장 명확한 수론적 질서를 제시합니다.',
